...
public class Client implements XOconstants{
    
    private boolean myTurn = false;
    private char myToken = ' ';
    private char otherToken = ' ';
    private Label lblTitle = new Label(); // Create and initialize a title label
    private Label lblStatus = new Label(); // Create and initialize a status label
    private int rowSelected;  // Indicate selected row and column by the current move
 ...
 // Continue to play
   ...
   /** Wait for the player to mark a cell */
    ...
    int status = fromServer.readInt(); // Receive game status
